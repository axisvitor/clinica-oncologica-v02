...
- [x] **S05: S05** `risk:The milestone can fix visible code paths while leaving JWT revocation semantics, deployment secret posture, DB TLS/RLS claims, R012/R013 mapping or M013 regressions unverifiable.` `depends:[]`

...
- [ ] **T03: Fix flow, batch, and simple service test files** `est:45m`
...
- [ ] **T04: Fix retry, exception, and Celery-deep test files** `est:1h`
...
- [ ] **T05: Fix mock-pattern saga/integration tests + run full verification** `est:1h`

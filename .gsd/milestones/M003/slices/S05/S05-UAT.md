...
- Do not mark `.gsd/milestones/M003/M003-ROADMAP.md` or move `R037`, `R038`, `R039` in `.gsd/REQUIREMENTS.md` until legacy `/session/logout` is explained or fixed and the routed `/admin`, `/dashboard`, `/whatsapp` smoke is rerun.

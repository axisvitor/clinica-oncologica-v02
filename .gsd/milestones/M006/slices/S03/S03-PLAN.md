...
- [ ] **T02: Delete dead frontend compatibility barrels and Firebase Hosting residue** `est:30m`
...
- [ ] **T03: Republish operator-facing config defaults and deployment manifests** `est:45m`
...
- [ ] **T04: Fix workflow and documentation narrative drift, classify historical archive** `est:45m`

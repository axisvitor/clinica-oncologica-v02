...
- [x] **T02: Converge remaining helper consumers and acceptance proof on the cookie-only contract** `est:1h30m`
...
- [x] **T03: Tombstone `/session/*` and republish the backend residue boundary** `est:1h`

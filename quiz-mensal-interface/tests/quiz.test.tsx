...
describe('Quiz Interface Integration Tests', () => {
  ...
  describe('Yes/No Question', () => {
    it('should render yes and no options', () => {
      const session = new QuizSessionBuilder().withQuestions([fixtures.yesNoQuestion()]).build()
  ...
  describe('Scale Question', () => {
    it('should render scale buttons', () => {
      const session = new QuizSessionBuilder().withQuestions([fixtures.scaleQuestion()]).build()
  ...
  describe('Text Question', () => {
    it('should render textarea for text question', () => {
      const session = new QuizSessionBuilder().withQuestions([fixtures.textQuestion()]).build()

...
- [x] 17-13-PLAN.md — Fix DLQ test fixtures to use real Patient row for FK-safe FailedMessage inserts and close fail-fast gate
...
| 18. Flow Service Splits | 2/4 | In Progress|  | - |

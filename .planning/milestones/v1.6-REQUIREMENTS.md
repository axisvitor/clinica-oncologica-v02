# Requirements Archive: v1.6 WuzAPI Migration

**Archived:** 2026-03-03
**Status:** All v1.6 requirements complete (33/33)
...
- **Validated:** CLI-01..CLI-06, WH-01..WH-06, SESS-01..SESS-03, CFG-01..CFG-03, OUT-01..OUT-04, CLEAN-01..CLEAN-06, TEST-01..TEST-05.
- **Adjusted during delivery:**
  - `WH-04` hardened in Phase 39 by sourcing webhook secret from centralized settings instead of direct environment lookup.
  - `OUT-02` corrected in Phase 39 by returning HTTP 501 for unsupported contacts sync instead of misleading HTTP 200.
- **Dropped:** None.
...
*Archived: 2026-03-03 — milestone v1.6 complete*

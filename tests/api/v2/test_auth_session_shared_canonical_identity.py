"""Root test-path shim for backend shared canonical session identity tests.
...
CANONICAL_TEST = BACKEND_ROOT / "tests" / "api" / "v2" / "test_auth_session_shared_canonical_identity.py"

sys.path.insert(0, str(BACKEND_ROOT))
spec = importlib.util.spec_from_file_location("_backend_test_auth_session_shared_canonical_identity", CANONICAL_TEST)

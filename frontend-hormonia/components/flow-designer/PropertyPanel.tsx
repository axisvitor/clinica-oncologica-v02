  ...
  return (
    <div className="space-y-3">
      <div>
        ...
        <Textarea
          id="message-content"
          value={getStringFromConfig(node.data.config, 'content')}
      ...
      <div>
        ...
        <Select
          value={getStringFromConfig(node.data.config, 'message_type', 'text')}
  ...
  return (
    <div className="space-y-3">
      <div>
        ...
        <Select
          value={getStringFromConfig(node.data.config, 'operator', 'AND')}
      ...
      <div className="grid grid-cols-2 gap-2">
        <div>
          ...
          <Input
            id="delay-duration"
            type="number"
            value={getNumberFromConfig(node.data.config, 'duration', 1)}
        ...
        <div>
          ...
          <Select
            value={getStringFromConfig(node.data.config, 'unit', 'minutes')}
  ...
  return (
    <div className="space-y-3">
      <div>
        ...
        <Select
          value={getStringFromConfig(node.data.config, 'action_type', 'set_variable')}
  ...
  return (
    <div className="space-y-3">
      <div>
        ...
        <Textarea
          id="ai-prompt"
          value={getStringFromConfig(node.data.config, 'prompt_template')}
      ...
      <div>
        ...
        <Input
          id="ai-fallback"
          value={getStringFromConfig(node.data.config, 'fallback_message')}

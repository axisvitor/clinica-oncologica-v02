...
import { MoreHorizontal, Eye, Edit, Trash2, Play, Pause, Send } from 'lucide-react'
      ...
      <Table>
        ...
        <TableBody>
          {patients.map((patient) => {
            // Hook call inside the component body - conditionally rendered
            const PatientQuizStatus = () => {

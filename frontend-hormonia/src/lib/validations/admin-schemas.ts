 ...
 */
export const passwordChangeSchema = passwordResetSchema.extend({
 ...
 */
export function validateEmailDomain(email: string, role: UserRole): { valid: boolean; message?: string } {

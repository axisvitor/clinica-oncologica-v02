                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-gray-600">
                        {user['role'] === 'super_admin' && 'Acesso completo ao sistema com privilégios de super administrador.'}
                        ...
                        {user['role'] === 'nurse' && 'Acesso a dados de pacientes e acompanhamento de tratamentos.'}
                        {user['role'] === 'patient' && 'Acesso limitado aos próprios dados médicos e tratamentos.'}
                        {user['role'] === 'researcher' && 'Acesso a dados anonimizados para pesquisa e análise.'}
                        {user['role'] === 'coordinator' && 'Coordenação de equipes e processos clínicos.'}
                      </p>
                    </div>
                  </CardContent>
                </Card>

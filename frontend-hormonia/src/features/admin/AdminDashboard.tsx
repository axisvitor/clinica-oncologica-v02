...
import { AdminUserActivity, SecurityMetrics } from '@/types/admin'
            ...
            {dashboardStats && dashboardStats.audit.critical_events > 0 && (
              <Alert className="border-red-200 bg-red-50">
                ...
                <AlertDescription className="text-red-800">
                  {dashboardStats.audit.critical_events} critical security event(s) require
                  immediate attention.
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <Card>
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  ...
                  <Shield
                    className={`h-4 w-4 ${getSecurityStatusColor(dashboardStats?.security.failed_logins || 0)}`}
                  />
                </CardHeader>
                <CardContent>
                  <div className="text-2xl font-bold">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">
                    {formatUptime(dashboardStats?.system.uptime || 0)}
                  </div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <span className="font-medium">
                            {dashboardStats?.users.new_today || 0}
                          </span>
                        </div>
                      </div>
                    </CardContent>
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <Progress
                          value={dashboardStats?.system?.memory_usage ?? 0}
                          className="h-2"
                        />
                      </div>

  ...
  ({ data, detailed = false }) => {
    ...
    const processingData = useMemo(
      () => [
        ...
        {
          category: 'Originais',
          count: data.total_messages_processed - data.personalized_messages,
          color: '#E5E7EB',
        },
      ],
    ...
    const safetyData = useMemo(
      () => [
        {
          metric: 'Mensagens Seguras',
          value: data.total_messages_processed - data.safety_interventions,
        },
          ...
          <div className="grid grid-cols-3 gap-4 text-center">
            <div className="bg-purple-50 p-3 rounded-lg">
              <div className="text-lg font-bold text-purple-600">
                {data.personalization_rate.toFixed(1)}%
              </div>
              <div className="text-sm text-purple-800">Personalização</div>
            </div>
            <div className="bg-blue-50 p-3 rounded-lg">
              <div className="text-lg font-bold text-blue-600">
                {data.response_quality_score.toFixed(1)}
              </div>
        ...
        <div className="grid md:grid-cols-4 gap-4">
          ...
          <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-4 rounded-lg border border-blue-200">
            <div className="text-2xl font-bold text-blue-700">
              {data.avg_personalization_score.toFixed(1)}
            </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-medium">
                    {data['total_messages_processed'].toLocaleString()}
                  </span>
                </div>
                <div className="flex items-center justify-between">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-medium">
                    {data.avg_personalization_score.toFixed(1)}/100
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-medium">
                    {(
                      (data['safety_interventions'] / data['total_messages_processed']) *
                      100
                    ).toFixed(2)}
                    %
                  </span>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-medium text-green-600">
                    {(
                      (1 - data['safety_interventions'] / data['total_messages_processed']) *
                      100
                    ).toFixed(1)}
                    %
                  </span>
            ...
            <div className="mt-6 pt-4 border-t border-gray-200">
              ...
              <div className="flex flex-wrap gap-4">
                {impactMetrics.map((impact, index) => (
                  <div
                    key={index}
                    className="bg-white p-3 rounded-lg border border-gray-200 min-w-0 flex-1"
                  >
                    <div

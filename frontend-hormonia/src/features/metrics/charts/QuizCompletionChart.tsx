          ...
          <div className="grid grid-cols-3 gap-4 text-center">
            ...
            <div className="bg-blue-50 p-3 rounded-lg">
              <div className="text-lg font-bold text-blue-600">
                {data.avg_completion_time_minutes.toFixed(0)}min
              </div>
              ...
              <Suspense fallback={<ChartSkeleton />}>
                <ResponsiveContainer width="100%" height="100%">
                  <PieChart>
                    ...
                    <Tooltip formatter={(value: ValueType) => [value, 'Quizzes']} />
                    <Legend />
                  </PieChart>
                </ResponsiveContainer>
              </Suspense>
          ...
          <div className="grid md:grid-cols-2 gap-4 text-sm">
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className="font-medium text-green-600">{bestQuiz?.type || 'N/A'}</span>
              </div>
              <div className="flex items-center justify-between">
                <span>Tempo médio por quiz:</span>
                <span className="font-medium">
                  {data.avg_completion_time_minutes.toFixed(1)} minutos
                </span>
              </div>
            </div>
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className="font-medium text-orange-600">
                  {data.monthly_quiz_stats.in_progress}
                </span>
              </div>
              <div className="flex items-center justify-between">
                ...
                <span className="font-medium text-red-600">
                  {(
                    (data.monthly_quiz_stats.expired / data.monthly_quiz_stats.total_sent) *
                    100
                  ).toFixed(1)}
                  %
                </span>

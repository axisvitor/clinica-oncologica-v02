...
export const EngagementChart: React.FC<EngagementChartProps> = ({ data, detailed = false }) => {
    ...
    <div className="space-y-8">
            ...
            <Suspense fallback={<ChartSkeleton />}>
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  ...
                  <Tooltip formatter={(value: ValueType) => [value, 'Pacientes']} />
                  <Legend />
                </PieChart>
              </ResponsiveContainer>
            </Suspense>
      ...
      <div className="space-y-2">
        ...
        <div className="h-64">
          <Suspense fallback={<ChartSkeleton />}>
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={responseMetrics} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
                <CartesianGrid strokeDasharray="3 3" stroke="#E5E7EB" />
                <XAxis
                  dataKey="metric"
                  tick={{ fontSize: 12 }}

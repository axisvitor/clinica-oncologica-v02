    ...
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">Total: {stats.total_flows}</p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{formatPercentage(stats.completion_rate)}</div>
          <p className="text-xs text-muted-foreground">{stats.completed_flows} concluídos</p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{formatTime(stats.average_duration_days)}</div>

...
const AdminDashboard = lazy(() => {
  ...
  return import('../components/admin/AdminDashboard').then(module => {
...
const AdminLoginForm = lazy(() => {
  ...
  return import('../components/admin/AdminLoginForm');
});

const AdminProtectedRoute = lazy(() => {
  logger.info('Loading AdminProtectedRoute...');
  return import('../components/admin/AdminProtectedRoute');
});
...
const AdminUserActivityMonitor = lazy(() => {
  logger.info('Loading AdminUserActivityMonitor...');
  return import('../components/admin/AdminUserActivityMonitor');
});
...
export const preloadCriticalComponents = () => {
  ...
  const dashboardPreload = import('../components/admin/AdminDashboard');

  // Preload protected route wrapper
  const protectedRoutePreload = import('../components/admin/AdminProtectedRoute');

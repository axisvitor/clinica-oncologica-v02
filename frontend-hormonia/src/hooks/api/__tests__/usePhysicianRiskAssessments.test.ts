...
import { usePhysicianRiskAssessments } from '../usePhysicianRiskAssessments'
...
describe('usePhysicianRiskAssessments', () => {
  ...
  it('should filter by patient_id when provided', async () => {
    ...
    expect(apiClient.request).toHaveBeenCalledWith(
      '/api/v2/analytics/physicians/risk-assessments?patient_id=p123'
    )
  })
  ...
  it('should use different cache for different patient_ids', async () => {
    ...
    expect(apiClient.request).toHaveBeenCalledWith(
      '/api/v2/analytics/physicians/risk-assessments?patient_id=p1'
    )
    expect(apiClient.request).toHaveBeenCalledWith(
      '/api/v2/analytics/physicians/risk-assessments?patient_id=p2'
    )
  })

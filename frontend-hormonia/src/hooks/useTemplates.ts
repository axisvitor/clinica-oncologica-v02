...
export function useTemplates() {
  ...
  const createFlowTemplate = useCallback(
    async (data: FlowTemplateCreate): Promise<FlowTemplate | null> => {
      setLoading(true)
      try {
        const payload = {
          ...data,
  ...
  const listFlowTemplates = useCallback(
    async (params?: {
      is_active?: boolean
      is_draft?: boolean
      kind_key?: string
      ...
      setLoading(true)
      try {
        const response = await apiClient.get<PaginatedResponse<FlowTemplate>>(
  ...
  const getFlowTemplate = useCallback(
    async (templateId: string): Promise<FlowTemplate | null> => {
      setLoading(true)
      try {
  ...
  const updateFlowTemplate = useCallback(
    async (templateId: string, data: FlowTemplateUpdate): Promise<FlowTemplate | null> => {
      setLoading(true)
      try {
        const response = await apiClient.put<FlowTemplate>(
          `/api/v2/templates/flows/${templateId}`,
          data
        )
  ...
  const deleteFlowTemplate = useCallback(
    async (templateId: string, softDelete: boolean = true): Promise<boolean> => {
      setLoading(true)
      try {
        ...
        toast({
          ...
          description: softDelete
            ...
            : 'Template deletado permanentemente',
        })
  ...
  const listFlowTemplateVersions = useCallback(
    async (templateId: string): Promise<FlowTemplateVersionList | null> => {
      setLoading(true)
      try {
  ...
  const compareFlowTemplateVersions = useCallback(
    async (
      templateId: string,
  ...
  const rollbackFlowTemplateVersion = useCallback(
    async (
      templateId: string,
      reason?: string,
      setAsActive?: boolean
  ...
  const publishFlowTemplateVersion = useCallback(
    async (templateId: string, setAsActive?: boolean): Promise<FlowTemplate | null> => {
      setLoading(true)
      try {
  ...
  const createQuizTemplate = useCallback(
    async (data: QuizTemplateCreate): Promise<QuizTemplate | null> => {
      setLoading(true)
      try {
  ...
  const listQuizTemplates = useCallback(
    async (params?: {
      is_active?: boolean
      category?: string
      page?: number
      ...
      setLoading(true)
      try {
        const response = await apiClient.get<PaginatedResponse<QuizTemplate>>(
  ...
  const getQuizTemplate = useCallback(
    async (quizId: string): Promise<QuizTemplate | null> => {
      setLoading(true)
      try {
  ...
  const updateQuizTemplate = useCallback(
    async (quizId: string, data: QuizTemplateUpdate): Promise<QuizTemplate | null> => {
      setLoading(true)
      try {
  ...
  const deleteQuizTemplate = useCallback(
    async (quizId: string, softDelete: boolean = true): Promise<boolean> => {
      setLoading(true)
      try {

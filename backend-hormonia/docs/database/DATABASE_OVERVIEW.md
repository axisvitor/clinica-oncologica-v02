...
> Atualizado em **09/11/2025 20:08 Hora oficial do Brasil** com base no snapshot do ambiente real.
...
- **Relacionamentos**: 55 chaves estrangeiras ativas
- **Triggers**: 14 gatilhos
- **Enums personalizados**: 13 tipos
- **Índices**: 254 índices no total

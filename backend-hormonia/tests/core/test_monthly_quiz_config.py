...
class TestMonthlyQuizBaseURLValidation:
    ...
    def test_valid_https_url_accepted(self):
        ...
        with patch.dict(
            "os.environ",
            {
                "MONTHLY_QUIZ_BASE_URL": "https://quiz.example.com",
                "MONTHLY_QUIZ_TOKEN_SECRET": "test-secret-key-for-testing",
            },
        ):
    ...
    def test_multiple_trailing_slashes_handled(self):
        ...
        with patch.dict(
            "os.environ",
            {
                "MONTHLY_QUIZ_BASE_URL": "https://quiz.example.com/api/v1/",
                "MONTHLY_QUIZ_TOKEN_SECRET": "test-secret-key-for-testing",
            },
        ):
            config = MonthlyQuizConfig()
    ...
    def test_invalid_url_rejected(self):
        ...
        with patch.dict(
            "os.environ",
            {
                "MONTHLY_QUIZ_BASE_URL": "not-a-valid-url",
                "MONTHLY_QUIZ_TOKEN_SECRET": "test-secret-key-for-testing",
            },
        ):
            ...
            assert "MONTHLY_QUIZ_BASE_URL" in error_str or "url" in error_str.lower()
    ...
    def test_empty_url_rejected(self):
        ...
        with patch.dict(
            ...
            error_str = str(exc_info.value)
            assert "MONTHLY_QUIZ_BASE_URL" in error_str or "empty" in error_str.lower()
    ...
    def test_whitespace_only_url_rejected(self):
        ...
        with patch.dict(
            ...
            error_str = str(exc_info.value)
            assert "MONTHLY_QUIZ_BASE_URL" in error_str
    ...
    def test_ftp_scheme_rejected(self):
        ...
        with patch.dict(
            "os.environ",
            {
                "MONTHLY_QUIZ_BASE_URL": "ftp://files.example.com",
                "MONTHLY_QUIZ_TOKEN_SECRET": "test-secret-key-for-testing",
            },
        ):
            with pytest.raises(ValidationError) as exc_info:
            ...
            error_str = str(exc_info.value)
            assert "MONTHLY_QUIZ_BASE_URL" in error_str or "scheme" in error_str.lower()
    ...
    def test_url_with_port_accepted(self):
        ...
        with patch.dict(
            "os.environ",
            {
                "MONTHLY_QUIZ_BASE_URL": "https://quiz.example.com:8443",
                "MONTHLY_QUIZ_TOKEN_SECRET": "test-secret-key-for-testing",
            },
        ):
            config = MonthlyQuizConfig()
    ...
    def test_default_url_valid(self):
        ...
        with patch.dict(
            ...
            import os
            env_backup = os.environ.pop("MONTHLY_QUIZ_BASE_URL", None)
            try:
                config = MonthlyQuizConfig()
                assert config.MONTHLY_QUIZ_BASE_URL == "https://quiz-interface-production.up.railway.app"
            finally:
                if env_backup:
                    os.environ["MONTHLY_QUIZ_BASE_URL"] = env_backup
...
class TestMonthlyQuizLinkGeneration:
    ...
    def test_link_generation_with_path(self):
        ...
        with patch.dict(
            "os.environ",
            {
                "MONTHLY_QUIZ_BASE_URL": "https://quiz.example.com/quiz/monthly/",
                "MONTHLY_QUIZ_TOKEN_SECRET": "test-secret-key-for-testing",
            },
        ):
            config = MonthlyQuizConfig()

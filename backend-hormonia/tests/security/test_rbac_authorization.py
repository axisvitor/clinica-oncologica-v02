...
from app.api.v2.routers.admin.dependencies import _require_admin
...
class TestRBACAuthorization:
    ...
    def test_admin_endpoints_reject_doctor(self, doctor_user):
        with pytest.raises(HTTPException) as exc_info:
            _require_admin(doctor_user)
        assert exc_info.value.status_code == 403

    def test_admin_endpoints_accept_admin(self, admin_user):

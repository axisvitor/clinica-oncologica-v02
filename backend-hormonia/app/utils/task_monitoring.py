...
class TaskLogger:
    ...
    @staticmethod
    def log_task_start(task_name: str, task_id: str, args: List[Any], kwargs: Dict[str, Any]):
    ...
    @staticmethod
    def log_task_failure(task_name: str, task_id: str, error: str, traceback: str, runtime: float):
    ...
    @staticmethod
    def log_task_retry(task_name: str, task_id: str, error: str, retry_count: int, countdown: int):
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=4) as executor:
            ...
            for key, future in futures.items():
                try:
                    ...
                    results[key] = [] if key in ['active_tasks', 'scheduled_tasks'] else {}
...
async def health_check_async() -> Dict[str, Any]:
    ...
    try:
        ...
        monitoring_data = await asyncio.wait_for(
            get_task_monitoring_data_async(),
            timeout=15.0
        )

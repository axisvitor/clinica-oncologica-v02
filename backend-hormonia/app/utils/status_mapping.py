...
class StatusMapper:
    ...
    @classmethod
    def link_to_unified(cls, link_status: Union[str, QuizLinkStatus]) -> UnifiedQuizStatus:
        ...
        if status_str not in cls.LINK_TO_UNIFIED:
            ...
            raise StatusMappingError(f"Cannot map link status '{status_str}' to unified status")
    ...
    @classmethod
    def session_to_unified(cls, session_status: Union[str, QuizSessionStatus]) -> UnifiedQuizStatus:
        ...
        if status_str not in cls.SESSION_TO_UNIFIED:
            ...
            raise StatusMappingError(f"Cannot map session status '{status_str}' to unified status")
    ...
    @classmethod
    def unified_to_link(cls, unified_status: Union[str, UnifiedQuizStatus]) -> QuizLinkStatus:
        ...
        if status_str not in cls.UNIFIED_TO_LINK:
            ...
            raise StatusMappingError(f"Cannot map unified status '{status_str}' to link status")
    ...
    @classmethod
    def unified_to_session(cls, unified_status: Union[str, UnifiedQuizStatus]) -> QuizSessionStatus:
        ...
        if status_str not in cls.UNIFIED_TO_SESSION:
            ...
            raise StatusMappingError(f"Cannot map unified status '{status_str}' to session status")
    ...
    @classmethod
    def link_to_session(cls, link_status: Union[str, QuizLinkStatus]) -> QuizSessionStatus:
    ...
    @classmethod
    def session_to_link(cls, session_status: Union[str, QuizSessionStatus]) -> QuizLinkStatus:
    ...
    @classmethod
    def is_active_status(cls, status: Union[str, UnifiedQuizStatus, QuizLinkStatus, QuizSessionStatus]) -> bool:
    ...
    @classmethod
    def is_completed_status(cls, status: Union[str, UnifiedQuizStatus, QuizLinkStatus, QuizSessionStatus]) -> bool:
    ...
    @classmethod
    def is_terminated_status(cls, status: Union[str, UnifiedQuizStatus, QuizLinkStatus, QuizSessionStatus]) -> bool:
    ...
    @classmethod
    def get_frontend_status(cls,
                          link_status: Optional[Union[str, QuizLinkStatus]] = None,
                          session_status: Optional[Union[str, QuizSessionStatus]] = None) -> str:
        """
        ...
        try:
            ...
            logger.warning(f"Error mapping frontend status: {e}. Using default 'active'")
            return "active"

    @classmethod
    def validate_status_consistency(cls,
                                  link_status: Union[str, QuizLinkStatus],
                                  session_status: Union[str, QuizSessionStatus]) -> Dict[str, Union[bool, str]]:
        """
        ...
        try:
            ...
            valid_combinations = {
                ...
                (UnifiedQuizStatus.ACTIVE, UnifiedQuizStatus.CANCELLED),  # User cancelled after link was active
            }
            ...
            return {
                "is_valid": False,
                "message": f"Status validation failed: {e}"
            }
...
def map_session_to_link(session_status: Union[str, QuizSessionStatus]) -> QuizLinkStatus:
    """Convenience function to map session status to link status."""
    return status_mapper.session_to_link(session_status)

def get_frontend_status(link_status: Optional[str] = None, session_status: Optional[str] = None) -> str:
...
def validate_status_consistency(link_status: str, session_status: str) -> Dict[str, Union[bool, str]]:

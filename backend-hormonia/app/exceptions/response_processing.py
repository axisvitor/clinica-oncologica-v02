...
class ResponseValidationError(ValidationError):
    ...
    def __init__(self, message: str, validation_errors: List[str], patient_id: Optional[UUID] = None):
...
class ResponseProcessingError(ProcessingError):
    ...
    def __init__(self, message: str, patient_id: Optional[UUID] = None, original_error: Optional[Exception] = None):
        super().__init__(message)
        self.patient_id = patient_id
...
class AIProcessingError(ProcessingError):
    ...
    def __init__(self, message: str, service_name: str, patient_id: Optional[UUID] = None):
        super().__init__(message)
...
class FlowStateError(ProcessingError):
    ...
    def __init__(self, message: str, patient_id: UUID, flow_state_id: Optional[UUID] = None):
        super().__init__(message)
        self.patient_id = patient_id

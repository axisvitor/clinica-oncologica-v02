...
class DataProtectionService:
    ...
    def sanitize_for_logging(
        ...
        preserve_types: List[SensitiveDataType] = None,
    ) -> Union[str, Dict, List]:
    ...
    def _sanitize_string(
        self, text: str, preserve_types: List[SensitiveDataType]
    ) -> str:
    ...
    def _sanitize_dict(
        self, data: Dict, preserve_types: List[SensitiveDataType]
    ) -> Dict:
    ...
    def log_sensitive_access(
        ...
        try:
            audit_entry = {
                ...
                "ip_address": additional_context.get("ip_address")
                if additional_context
                else None,
                "user_agent": additional_context.get("user_agent")
                if additional_context
                else None,

        ...
        **kwargs
        ...
        try:
            ...
            error_response = await graceful_error_handler.handle_database_error(
                ...
                query_context={"circuit_state": "open", "fallback_enabled": self.enable_fallback}
            )
            ...
            raise await graceful_error_handler.create_http_exception_from_error_response(
                error_response
            )
        ...
        **kwargs
        ...
        try:
            ...
            error_response = await graceful_error_handler.handle_database_error(
                error=e,
                operation="database_transaction",
                query_context={"transaction": True, "rollback": rollback_on_circuit_open}
            )
            raise await graceful_error_handler.create_http_exception_from_error_response(
                error_response
            )
...
async def protected_write_query(
    query_func: Callable,
    *args,
    **kwargs
) -> Any:

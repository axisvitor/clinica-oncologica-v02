...
from app.services.performance_monitoring.models import PerformanceMetric, PerformanceBottleneck
...
class PerformanceReporter:
    ...
    async def generate_performance_report(
        ...
        current_bottlenecks: List[PerformanceBottleneck]
    ) -> dict[str, Any]:
        ...
        try:
            ...
            recommendations = self.analyzer.generate_performance_recommendations(stats, current_bottlenecks)
    ...
    async def generate_real_time_dashboard(
        ...
        try:
            ...
            recent_metrics = await self.collector.get_metrics_for_range(one_hour_ago, datetime.utcnow())
            ...
            dashboard_data = {
                ...
                'system_health': await self._get_system_health_summary(active_bottlenecks),
    ...
    async def _get_system_health_summary(self, bottlenecks: List[PerformanceBottleneck]) -> dict[str, Any]:
    ...
    def _get_performance_alerts(self, bottlenecks: List[PerformanceBottleneck]) -> List[dict[str, Any]]:

            ...
            for concern in medical_concerns:
                ...
                if concern_level in [ConcernLevel.HIGH, ConcernLevel.CRITICAL]:
                    ...
                    action = FollowUpAction(
                        ...
                        priority="high",
                        scheduled_for=now_sao_paulo() + timedelta(minutes=10),
                        parameters={
                            "concern": concern,
                    ...
                    action = FollowUpAction(
                        ...
                        priority="medium",
                        scheduled_for=now_sao_paulo() + timedelta(minutes=30),
                        parameters={
                            "concern": concern,
                            "concern_type": concern_type.value
                            if concern_type
        ...
        try:
            ...
            if "pain_scale" in extracted_data:
                ...
                if pain_level >= 7:
                    action = FollowUpAction(
                        ...
                        follow_up_type=FollowUpType.MEDICAL_CLARIFICATION,
                        priority="high",
                        scheduled_for=now_sao_paulo() + timedelta(minutes=15),
                        parameters={
            ...
            if extracted_data.get("medication_mentioned"):
                action = FollowUpAction(
                    ...
                    priority="normal",
                    scheduled_for=now_sao_paulo() + timedelta(hours=2),
                    parameters={
            ...
            if extracted_data.get("mood_indicator") == "negative":
                action = FollowUpAction(
                    ...
                    priority="normal",
                    scheduled_for=now_sao_paulo() + timedelta(hours=1),
                    parameters={
            ...
            # Handle positive responses with encouragement
                ...
                action = FollowUpAction(
                    ...
                    priority="low",
                    scheduled_for=now_sao_paulo() + timedelta(hours=4),
                    parameters={

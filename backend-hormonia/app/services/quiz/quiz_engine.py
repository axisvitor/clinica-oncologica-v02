...
class QuizEvaluator:
    ...
    def evaluate_response(self, response: QuizResponse, question: QuizQuestion) -> Dict[str, Any]:
    ...
    def _evaluate_multiple_choice(self, response: QuizResponse, question: QuizQuestion) -> Dict[str, Any]:
    ...
    def _evaluate_text(self, response: QuizResponse, question: QuizQuestion) -> Dict[str, Any]:
    ...
    def _evaluate_scale(self, response: QuizResponse, question: QuizQuestion) -> Dict[str, Any]:
...
class QuizScorer:
    ...
    def calculate_session_score(self, session: QuizSession, template: QuizTemplate) -> Dict[str, Any]:

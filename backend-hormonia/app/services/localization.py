...
class LocalizationService:
    ...
    def __init__(self, default_locale: str = "en"):
        ...
        logger.info(f"Localization service initialized with default locale: {default_locale}")
        ...
        **kwargs
        ...
        try:
            ...
            if locale != self.default_locale:
                try:
                    default_translations = self.get_translations(self.default_locale, namespace)
    ...
    def get_localized_flow_template(
        ...
        # Translate metadata
        localized_template['name'] = self.translate_flow_metadata(flow_type, 'name', locale)
        localized_template['description'] = self.translate_flow_metadata(flow_type, 'description', locale)

        ...
        async with self._lock:
            ...
            if self.state == CircuitState.OPEN:
                if self._should_attempt_reset():
                    ...
                    self.stats.state_changes.append((CircuitState.HALF_OPEN, datetime.utcnow()))
        ...
        async def fallback():
            ...
            if question.get('options'):
                ...
                for option in question['options']:
                    if option['text'].lower() in response_lower or \
                       response_lower in option['text'].lower():
                        return {

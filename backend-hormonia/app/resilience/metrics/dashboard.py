...
def create_metrics_blueprint() -> Blueprint:
    ...
    def get_current_metrics():
        ...
        try:
            ...
            return jsonify(
                {"status": "success", "data": current_metrics.to_dict()}
            ), 200
    ...
    def get_aggregated_metrics():
        ...
        try:
            ...
            return jsonify({"status": "success", "data": aggregated}), 200
    ...
    def export_metrics():
        ...
        try:
            ...
            if format_type == "prometheus":
                ...
                return jsonify(
                    {"status": "success", "format": format_type, "data": exported_data}
                ), 200
    ...
    def get_component_metrics():
        ...
        try:
            ...
            return jsonify({"status": "success", "data": component_metrics}), 200
    ...
    def get_dashboard_data():
        ...
        try:
            ...
            overall_health = (
                circuit_breaker_health + retry_health + rate_limit_health
            ) / 3
    ...
    def get_metrics_status():
        ...
        try:
            status_info = {
                "collection_active": metrics_collector._collection_thread
                and metrics_collector._collection_thread.is_alive(),
...
def _calculate_circuit_breaker_health(metrics) -> float:
    ...
    total_requests = (
        metrics.circuit_breaker_successes + metrics.circuit_breaker_failures
    )

...
async def get_monitoring_health(service: MonitoringService = Depends(get_monitoring_service)):
...
@router.get("/apm/endpoint/{endpoint_path:path}", response_model=APMEndpointDetailResponse)

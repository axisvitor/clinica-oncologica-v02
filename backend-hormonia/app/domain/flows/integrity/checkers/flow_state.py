...
class FlowStateChecker:
    ...
    def _check_current_step(self, flow_state: PatientFlowState) -> list[CorruptionIssue]:
    ...
    def _check_date_consistency(self, flow_state: PatientFlowState) -> list[CorruptionIssue]:
    ...
    def _check_state_data_json(self, flow_state: PatientFlowState) -> list[CorruptionIssue]:
    ...
    def _check_flow_duration(self, flow_state: PatientFlowState) -> list[CorruptionIssue]:
    ...
    def _check_patient_reference(self, flow_state: PatientFlowState) -> list[CorruptionIssue]:
    ...
    async def _check_duplicate_active_flows(self, patient_id: Optional[UUID]) -> list[CorruptionIssue]:
        ...
        try:
            query = self.db.query(
                ...
                func.count(PatientFlowState.id) > 1
            )

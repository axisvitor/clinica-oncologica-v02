...
class BackupManager:
    ...
    @staticmethod
    def create_flow_state_backup(flow_state, field_name: str, original_value: Any) -> dict[str, Any]:
        """
    ...
    @staticmethod
    def create_message_backup(message, field_name: str, original_value: Any) -> dict[str, Any]:
        """
    ...
    @staticmethod
    def create_duplicate_flows_backup(kept_flow, completed_flows: list) -> dict[str, Any]:
        """

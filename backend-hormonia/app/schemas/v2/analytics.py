...
class PatientEngagement(BaseModel):
    ...
    engagement_levels: EngagementLevels = Field(..., description="Engagement distribution")
...
class TreatmentDistribution(BaseModel):
    ...
    distribution: List[TreatmentDistributionItem] = Field(..., description="Distribution data")
    ...
    model_config = ConfigDict(json_schema_extra={
            "example": {
                ...
                "total_patients": 140,
                "distribution": [
                    {"treatment_type": "Quimioterapia", "count": 45, "percentage": 32.14, "color": "#2563eb"},
                    {"treatment_type": "Radioterapia", "count": 30, "percentage": 21.43, "color": "#10b981"},
                    {"treatment_type": "Imunoterapia", "count": 25, "percentage": 17.86, "color": "#f59e0b"}
                ],
                "trend_data": [

...
class PermissionAssignRequest(BaseModel):
    ...
    permissions: List[str] = Field(..., min_length=1, description="List of permission names to assign")
...
class ActivityStatsResponse(BaseModel):
    ...
    model_config = ConfigDict(json_schema_extra={
        "example": {
            ...
            "most_active_users": [{"user_email": "admin@example.com", "event_count": 320}]
        }
    })
...
class BulkDeleteRequest(BaseModel):
    ...
    user_ids: List[UUID] = Field(..., min_length=1, max_length=50, description="List of user IDs to delete")
    reason: Optional[str] = Field(None, max_length=500, description="Reason for bulk deletion")
...
class UserSearchRequest(BaseModel):
    ...
    created_after: Optional[datetime] = Field(None, description="Filter users created after")
    created_before: Optional[datetime] = Field(None, description="Filter users created before")

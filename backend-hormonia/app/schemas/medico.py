...
class EngagementMetrics(BaseModel):
    ...
    avg_response_time_minutes: Optional[int] = Field(None, ge=0, description="Average response time in minutes")
...
class MedicoDashboardStats(BaseModel):
    ...
    consultas_hoje: int = Field(..., ge=0, description="Today's appointments/consultations")

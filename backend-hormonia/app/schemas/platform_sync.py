...
class AuthenticationRequest(BaseModel):
    ...
    required_permissions: Optional[List[str]] = Field(
        None, description="List of required permissions for the request"
    )
...
class ConsistencyValidationRequest(BaseModel):
    ...
    entity_ids: Optional[List[UUID]] = Field(
        None, description="Specific entity IDs to check"
    )
    check_all: bool = Field(
        False, description="Check all entities of the specified type"
    )

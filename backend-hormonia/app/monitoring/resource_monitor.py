...
class ResourceMonitor:
    ...
    async def _store_snapshot_redis(self, snapshot: ResourceSnapshot) -> None:
        ...
        try:
            ...
            metrics = {
                ...
                "load_average_1m": snapshot.load_average[0] if snapshot.load_average else 0
            }
            ...
            if self._prev_disk_io and self._prev_network_io and self._prev_timestamp:
                ...
                if time_delta > 0:
                    # Disk I/O rates
                    disk_read_rate = (snapshot.disk_read_bytes - self._prev_disk_io[0]) / time_delta
                    disk_write_rate = (snapshot.disk_write_bytes - self._prev_disk_io[1]) / time_delta

                    # Network I/O rates
                    net_recv_rate = (snapshot.network_bytes_recv - self._prev_network_io[0]) / time_delta
                    net_sent_rate = (snapshot.network_bytes_sent - self._prev_network_io[1]) / time_delta
            ...
            self._prev_network_io = (snapshot.network_bytes_recv, snapshot.network_bytes_sent)
    ...
    def _empty_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "disk": {"read_bytes": 0, "write_bytes": 0, "read_count": 0, "write_count": 0},

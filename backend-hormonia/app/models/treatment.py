...
from sqlalchemy import Column, String, Date, ForeignKey, Text, Boolean, Enum as SQLEnum
...
class Treatment(BaseModel):
    ...
    patient = relationship(
        "Patient", back_populates="treatments", lazy="select", passive_deletes=True
    )
    doctor = relationship(
        "User",
        back_populates="treatments_managed",

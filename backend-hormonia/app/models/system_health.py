...
"""
from sqlalchemy import Column, String, Text, Boolean, DateTime, Enum, Integer, Float
...
class SystemIncident(BaseModel):
    ...
    service_name = Column(String(100), nullable=False) # e.g. "database-primary", "redis-cache"

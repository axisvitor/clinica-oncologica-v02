...
class Consent(BaseModel):
    ...
    patient = relationship(
        "Patient", back_populates="consents", foreign_keys=[patient_id], lazy="select"
    )
    consented_by = relationship(
        "User",
        back_populates="consents_managed",
        foreign_keys=[consented_by_id],
        lazy="select",
    )

# FLUXO HORMON[IA] – Mensal Padrão

## Dia 1

1. Oi [NOME], tudo bem por aí? ✨
...
1. [NOME], sabia que alguns estudos mostram que caminhar 15 minutos por dia pode reduzir sintomas de ansiedade, melhorar o humor e até auxiliar no sono?
...
1. Oi [NOME], hoje passei só pra perguntar:
...
1. Se você pudesse descrever sua rotina hoje com uma imagem, seria:
   🧘 Um mar calmo
   🌀 Um redemoinho
   ☀️ Um dia ensolarado
   ☁️ Um tempo nublado
...
1. Já ouviu falar do “autodiálogo positivo”?
...
1. Ei [NOME], estamos nos aproximando do nosso momento mais importante do mês:
   O Checkup mensal.
...
1. [NOME], chegou o momento mais importante do mês!

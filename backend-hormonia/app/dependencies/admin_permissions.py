"""
Admin permissions dependencies for user administration endpoints.

This module provides FastAPI dependencies for RBAC (Role-Based Access Control)
and admin action auditing. It ensures that only users with appropriate roles
can access restricted endpoints.

Moved from app/middleware/admin_permissions.py - this is NOT middleware,
it provides FastAPI Depends() dependencies.
"""
